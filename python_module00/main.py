...
def test_ft_exercise(exercise_file_name):
    ...
    try:
        folder = folders.get(exercise_file_name, ".")

        import_path = f"{folder}.{exercise_file_name}" if folder != "." else exercise_file_name
        # Import your exercise file
        # This is like doing: import ft_plot_area
        ft_module = __import__(import_path, fromlist=[exercise_file_name])
